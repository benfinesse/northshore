{
    ...
    class Slideshow {
        ...
        createFrame() {
            ...
            <defs>
            <pattern fill="#DFDBE5" id="pattern" width="80" height="80" patternUnits="userSpaceOnUse">
            <polygon id="Path-2" points="0 80 80 0 40 0 0 40"></polygon>
            <polygon id="Path-2-Copy" points="80 80 80 40 40 80"></polygon>
            </pattern>
            </defs>
            ...
            const animateSlides = () => {
                return new Promise((resolve, reject) => {
                    ...
                    anime({
                        ...
                        easing: this.settings.animation.slides.easing,
                        translateX: [dir === 'next' ? -200 : 100, 0],
                        translateY: [dir === 'next' ? -200 : 100, 0],
                        scale: [1.2,1]
                    });
        
                    // anime({
                    //     targets: [newSlide.querySelector('.title'), newSlide.querySelector('.description'), newSlide.querySelector('.link')],
                    //     duration: this.settings.animation.slides.duration*2,
                    //     easing: this.settings.animation.slides.easing,
