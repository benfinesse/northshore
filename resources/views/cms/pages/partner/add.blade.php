...
@section('content')
    ...
    <div class="col-12">
        <div class="card card-shadow card-pad0" style="padding: 20px">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('partner.store') }}" aria-label="{{ __('new-partner') }}" enctype="multipart/form-data">
                    @csrf

                    <div class="form-group row">
                        <label for="name" class="col-md-2 col-form-label text-md-right">Name <i class="fa fa-user-alt"></i></label>
                        <div class="col-md-8">
                            <input id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" required autofocus placeholder="partner name">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <textarea id="" type="text" class="form-control" name="website" required placeholder="Website">{{ old('website') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <textarea id="" type="text" rows="9" class="form-control myfield" name="details" placeholder="partner detail">{{ old('details') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="name" class="col-md-2 col-form-label text-md-right">Groups <i class="fa fa-boxes"></i></label>

                        <div class="col-md-8">

                            @foreach($categories as $category)
                                <input type="checkbox" name="groups[]" value="{{ $category->unid }}"> <span class="mr-4">{{ $category->name }}</span>
                            @endforeach
